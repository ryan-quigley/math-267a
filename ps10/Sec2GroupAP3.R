...
# $H_a: \mu > 140$
# Words
# The null hypothesis: the previous survey results are still accurate and relevant
# The alternative hypothesis: the old survey results are outdated and logging cars are actually being loaded more heavily in recent years.
# One-sided test: we want to determine whether or not to build the trestle to higher tolerances to accommodate heavier cars, so we are really only interested in the case where the average weight is greater than the hypothesized value.
